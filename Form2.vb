...
Public Class Form2
    ...
    Private Sub DisplayForm2Students()
        Try
            ...
            Using con As MySqlConnection = New MySqlConnection(myconnection)
                Dim query As String = "SELECT name, parent, telephone FROM schoolmanagement.registration WHERE class = 'FORM 2'"
